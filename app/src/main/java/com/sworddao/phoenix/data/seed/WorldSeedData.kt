...
import com.sworddao.phoenix.feature.world.data.CollectibleType
import com.sworddao.phoenix.feature.world.data.Landmark
import com.sworddao.phoenix.feature.world.data.LandmarkType
...
import com.sworddao.phoenix.feature.world.data.TravelMethod
import com.sworddao.phoenix.feature.world.data.UnlockRequirement
...
fun createAllRegions(): List<WorldRegion> = listOf(
        WorldRegion(
            id = "qingyuan_village",
...
fun createConnections(): List<RegionConnection> = listOf(
...
fun createLocations(): List<WorldLocation> = listOf(
        // Qingyuan Village
...
fun createLandmarks(): List<Landmark> = listOf(
...
fun createCollectibles(): List<CollectibleLocation> = listOf(
