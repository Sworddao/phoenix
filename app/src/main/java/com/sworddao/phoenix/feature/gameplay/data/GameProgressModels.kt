...
enum class GameMilestone(val displayName: String, val description: String) {
    ...
    FIRST_READING("初次阅读", "Complete your first reading practice"),
    FIRST_WRITING("初次书写", "Complete your first writing practice"),
...
data class GameProgress(
    ...
    val totalReadingPractices: Int = 0,
    val totalWritingPractices: Int = 0,
    ...
    val hasCompletedFirstReading: Boolean
        get() = GameMilestone.FIRST_READING in milestonesCompleted

    val hasCompletedFirstWriting: Boolean
        get() = GameMilestone.FIRST_WRITING in milestonesCompleted
